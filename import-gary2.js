...
for(let i=1;i<lines.length;i++){
  ...
  try{
    db.prepare('INSERT INTO listings (name,city,state,asking_price,revenue,industry,url,source,status) VALUES (?,?,?,?,?,?,?,?,?)').run(name,city,state,price,rev,industry,url,'crexi','active');
    count++;
